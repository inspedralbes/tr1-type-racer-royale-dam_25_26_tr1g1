  ...
  <div class="bg-gray-800 text-white rounded-lg shadow-lg p-6 w-full max-w-lg">
    ...
    <div class="space-y-4">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
          <label for="altura" class="block text-sm font-medium text-gray-400"
      ...
      <div>
        <label for="biografia" class="block text-sm font-medium text-gray-400"
          >Biografia</label
        >
        <textarea
          id="biografia"
      ...
      <div>
        <label for="foto_perfil" class="block text-sm font-medium text-gray-400"
